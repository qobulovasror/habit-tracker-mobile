      ...
      >
        ...
        <View style={[settingStyle.catGroup, { flexDirection: "column" }]}>
          <View style={[mainStyle.row, mainStyle.between]}>
            <Text style={[settingStyle.inputTitle, { fontSize: 23 }]}>
              Language
            </Text>
            <TouchableOpacity
              style={[
                settingStyle.btn,
                {
                  transform: [{ rotate: activeGroup.lang ? "180deg" : "0deg" }],
                },
              ]}
              onPress={() =>
                setActiveGroup({ ...activeGroup, lang: !activeGroup.lang })
              }
            >
          ...
          {activeGroup.lang && (
            <View style={{ margin: 10 }}>
              ...
              <TouchableOpacity
                style={settingStyle.confBtn}
                disabled={setConfig.language != "uzb"}
              >
                <Text
                  style={[
                    settingStyle.confBtnText,
        ...
        <View style={[settingStyle.catGroup, { flexDirection: "column" }]}>
          <View style={[mainStyle.row, mainStyle.between]}>
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  transform: [
                    { rotate: activeGroup.notif ? "180deg" : "0deg" },
                  ],
                },
              ]}
              onPress={() =>
                setActiveGroup({ ...activeGroup, notif: !activeGroup.notif })
              }
            >
              <MaterialIcons name="expand-more" size={25} color="#fff" />
            </TouchableOpacity>
          ...
          {activeGroup.notif && (
            <View style={{ margin: 10 }}>
              <TouchableOpacity
                style={settingStyle.confBtn}
                onPress={() => setSetConfig({ ...setConfig, notif: "on" })}
                disabled
              >
                <Text
                  style={[
              ...
              <TouchableOpacity
                style={settingStyle.confBtn}
                onPress={() => setSetConfig({ ...setConfig, notif: "medium" })}
                disabled
              >
                <Text
                  style={[
              ...
              <TouchableOpacity
                style={settingStyle.confBtn}
                onPress={() => setSetConfig({ ...setConfig, notif: "off" })}
                disabled
              >
        ...
        <View style={[settingStyle.catGroup, { flexDirection: "column" }]}>
          <View style={[mainStyle.row, mainStyle.between]}>
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  transform: [
                    { rotate: activeGroup.theme ? "180deg" : "0deg" },
                  ],
                },
              ]}
              onPress={() =>
                setActiveGroup({ ...activeGroup, theme: !activeGroup.theme })
              }
            >
              <MaterialIcons name="expand-more" size={25} color="#fff" />
            </TouchableOpacity>
          ...
          {activeGroup.theme && (
            <View style={{ margin: 10 }}>
              <TouchableOpacity
                style={settingStyle.confBtn}
                onPress={() => setSetConfig({ ...setConfig, theme: "dark" })}
              >
              ...
              <TouchableOpacity
                style={settingStyle.confBtn}
                onPress={() => setSetConfig({ ...setConfig, theme: "light" })}
                disabled
              >
                <Text
                  style={[
              ...
              <TouchableOpacity
                style={settingStyle.confBtn}
                onPress={() => setSetConfig({ ...setConfig, theme: "auto" })}
                disabled
              >
                <Text
                  style={[
